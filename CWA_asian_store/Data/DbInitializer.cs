        ...
        public void Seed()
            {
                ...
                modelBuilder.Entity<Customer>().HasData(
                   new Customer { Id = 1, FullName = "Анна Іваненко", Email = "anna@gmail.com", Address = "м. Київ, вул. Хрещатик, 10" },
                   new Customer { Id = 2, FullName = "Олег Петров", Email = "oleg@gmail.com", Address = "м. Львів, вул. Шевченка, 25" }
                );

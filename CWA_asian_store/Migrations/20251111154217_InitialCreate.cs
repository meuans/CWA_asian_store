    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "м. Київ, вул. Хрещатик, 10", "anna@gmail.com", "Анна Іваненко" },
                    { 2, "м. Львів, вул. Шевченка, 25", "oleg@gmail.com", "Олег Петров" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Японський суп з локшиною", "Рамен", 180m },
                    { 2, 2, "Корейська гостра капуста", "Кімчі", 120m },
                    { 3, 3, "Тайська локшина з куркою", "Пад Тай", 210m },
                    { 4, 1, "Асорті ролів та суші", "Суші-сет", 350m }
                });
